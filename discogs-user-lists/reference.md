...
**Parameters:**
- `username` (string, required) — The username of the Lists you are trying to fetch. _(e.g. `rodneyfool`)_
...
**Parameters:**
- `list_id` (string, required) — The ID of the List you are trying to fetch. _(e.g. `123`)_
